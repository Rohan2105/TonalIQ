...
const getBackendUrls = () => {
    ...
    return {
        ws: isLocal ? "ws://localhost:8000/api/predict/stream" : "wss://rohan21005-tonaliq-backend.hf.space/api/predict/stream",
        http: isLocal ? "http://localhost:8000/api/predict/file" : "https://rohan21005-tonaliq-backend.hf.space/api/predict/file",
        health: isLocal ? "http://localhost:8000/health" : "https://rohan21005-tonaliq-backend.hf.space/health"
    };
};
